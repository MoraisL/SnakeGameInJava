...
public class Grade extends JPanel implements ActionListener
{
    ...
    public Grade ()
    {
        ...
        ImageIcon bola_ = new ImageIcon(getClass().getResource("/image/bola.png"));
        bola = bola_.getImage();

        // Cria um icone do arquivo png e seta na imagem correspondente
        ImageIcon comida_ = new ImageIcon(getClass().getResource("/image/comida.png"));
        comida = comida_.getImage();

        // Cria um icone do arquivo png e seta na imagem correspondente
        ImageIcon cabeça_ = new ImageIcon(getClass().getResource("/image/cabeça.png"));
